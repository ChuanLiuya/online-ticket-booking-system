...
import type { createEventReqBody } from '@/types/event'
import { AppError } from '@/utils/errors'

const formRef = ref<FormInstance>()

const form = reactive<createEventReqBody>({
  title: '',
  description: '',
  location: '',
  startTime: new Date(),
...
const rules = reactive<FormRules<createEventReqBody>>({
  title: [
...
const submitForm = async () => {
  ...
  try {
    const response = await eventApi.create(form)
